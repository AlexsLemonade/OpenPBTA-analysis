...
palette_df <- palette_df %>%
  mutate(broad_histology_display = case_when(
      broad_histology_hex == broad_histology_other_hex ~ "Other",
    ...
    cancer_group_display = case_when(
      cancer_group_hex == cancer_group_other_hex ~ "Other",
      cancer_group == "High-grade glioma astrocytoma" ~ "Other high-grade gliomas",
      cancer_group == "Low-grade glioma astrocytoma" ~ "Other low-grade gliomas", 
      TRUE ~ cancer_group
    )
  ) 
```
