...
cancer_group_order_df <- histology_table %>% 
  ...
  dplyr::mutate(
    # replace "/" with " or "
    cancer_group = gsub("/"," or ",cancer_group),
...
color_palette_cancer_group <-
  c("#cc0000", "#4c0000", "#330000", "#7f2020", "#e57373", "#994d4d", "#663333", "#402020", "#ffbfbf", "#8c6969", "#8c1300", "#d94c36", "#591f16", "#cca099", "#4d3c39", "#f24100", "#b2502d", "#7f3920", "#33170d", "#cc8166", "#8c5946", "#59392d", "#ffd0bf", "#f26100", "#b24700", "#592400", "#e57e39", "#a65b29", "#402310", "#ffb380", "#b27d59", "#735039", "#332b26", "#f28100", "#733d00", "#bf7c30", "#4c3213", "#cc9c66", "#8c6c46", "#403120", "#e6cbac", "#998773", "#f2a200", "#7f5500", "#332200", "#bf8f30", "#e5bf73", "#4d4639", "#f2c200", "#403300", "#7f6c20", "#59502d", "#bfb68f", "#8c8569", "#bfb300", "#8c8300", "#4c4700", "#fff240", "#ccc566", "#99944d", "#33311a", "#fffbbf"
)
...
histology_table <- histology_table %>%
  ...
  dplyr::mutate(hex_codes = dplyr::recode(display_group, !!!subset_colors_display),
		cancer_group_hex_codes = dplyr::recode(cancer_group, !!!subset_colors_cancer_group),
                # is cancer_group is NA for tumor sample add gray color
