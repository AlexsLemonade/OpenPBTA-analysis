...
# # This directory is also created here because one of the scripts also generates S6 panels
...
# This directory was already created in a Figure 3 step, but this shouldn't hurt:
mkdir -p pdfs/supp/figs4/panels
...
# This directory was already created in a Figure 5 step, but this shouldn't hurt:
mkdir -p pdfs/supp/figs6/panels
