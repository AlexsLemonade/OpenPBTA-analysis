...
- Removing mitochondtial genes from the UMAP does not have a strong qualitiative effect on whether broad histologies or cancer groups tend to cluster together.
...
Overall, this suggests that mitochondrial genes likely do not have a strong influence on UMAP visualizations.
