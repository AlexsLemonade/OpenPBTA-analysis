...
polyA_rsem_pca_aligned_df <-
  readr::read_tsv(file.path(results_dir, "rsem_polyA_pca_scores_aligned.tsv"))

stranded_rsem_pca_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "rsem_stranded_pca_scores_aligned.tsv"))

rsem_pca_aligned_df <-
  readr::read_tsv(file.path(results_dir, "rsem_all_pca_scores_aligned.tsv"))

polyA_rsem_tsne_aligned_df <-
  readr::read_tsv(file.path(results_dir, "rsem_polyA_tsne_scores_aligned.tsv"))

stranded_rsem_tsne_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "rsem_stranded_tsne_scores_aligned.tsv"))

rsem_tsne_aligned_df <-
  readr::read_tsv(file.path(results_dir, "rsem_all_tsne_scores_aligned.tsv"))

polyA_rsem_umap_aligned_df <-
  readr::read_tsv(file.path(results_dir, "rsem_polyA_umap_scores_aligned.tsv"))

stranded_rsem_umap_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "rsem_stranded_umap_scores_aligned.tsv"))

rsem_umap_aligned_df <-
  readr::read_tsv(file.path(results_dir, "rsem_all_umap_scores_aligned.tsv"))

### Kallisto -------------------------------------------------------------------
polyA_kallisto_pca_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_polyA_pca_scores_aligned.tsv"))

stranded_kallisto_pca_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_stranded_pca_scores_aligned.tsv"))

kallisto_pca_aligned_df <-
  readr::read_tsv(file.path(results_dir, "kallisto_all_pca_scores_aligned.tsv"))

polyA_kallisto_tsne_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_polyA_tsne_scores_aligned.tsv"))

stranded_kallisto_tsne_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_stranded_tsne_scores_aligned.tsv"))

kallisto_tsne_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_all_tsne_scores_aligned.tsv"))

polyA_kallisto_umap_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_polyA_umap_scores_aligned.tsv"))

stranded_kallisto_umap_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_stranded_umap_scores_aligned.tsv"))

kallisto_umap_aligned_df <-
  readr::read_tsv(file.path(results_dir, 
                            "kallisto_all_umap_scores_aligned.tsv"))
```
...
polyA_rsem_pca_plot_histology <-
  plot_dimension_reduction(polyA_rsem_pca_aligned_df, "broad_histology", 1, 2)
...
polyA_rsem_grid_histology <-
  cowplot::plot_grid(polyA_rsem_grid_histology, legend_a, 
                     rel_heights = c(2, .2))
...
stranded_rsem_pca_plot_histology <-
  plot_dimension_reduction(stranded_rsem_pca_aligned_df, "broad_histology", 
                           1, 2)
stranded_rsem_tsne_plot_histology <-
  plot_dimension_reduction(stranded_rsem_tsne_aligned_df, "broad_histology", 
                           1, 2)
stranded_rsem_umap_plot_histology <-
  plot_dimension_reduction(stranded_rsem_umap_aligned_df, "broad_histology", 
                           1, 2)
...
polyA_kallisto_pca_plot_histology <-
  plot_dimension_reduction(polyA_kallisto_pca_aligned_df, "broad_histology", 
                           1, 2)
polyA_kallisto_tsne_plot_histology <-
  plot_dimension_reduction(polyA_kallisto_tsne_aligned_df, "broad_histology", 
                           1, 2)
polyA_kallisto_umap_plot_histology <-
  plot_dimension_reduction(polyA_kallisto_umap_aligned_df, "broad_histology", 
                           1, 2)
...
polyA_kallisto_grid_histology <-
  cowplot::plot_grid(polyA_kallisto_grid_histology, legend_a, 
                     rel_heights = c(2, .2))
...
stranded_kallisto_pca_plot_histology <-
  plot_dimension_reduction(stranded_kallisto_pca_aligned_df, "broad_histology", 
                           1, 2)
stranded_kallisto_tsne_plot_histology <-
  plot_dimension_reduction(stranded_kallisto_tsne_aligned_df, "broad_histology", 
                           1, 2)
stranded_kallisto_umap_plot_histology <-
  plot_dimension_reduction(stranded_kallisto_umap_aligned_df, "broad_histology", 
                           1, 2)
