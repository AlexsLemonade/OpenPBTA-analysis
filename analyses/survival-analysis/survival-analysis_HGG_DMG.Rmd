...
# find molecular subtypes which have more than 3 participants
filter_molecular_subtype <- metadata %>% group_by(molecular_subtype) %>% dplyr::tally() %>% dplyr::filter(n>3)

# select only molecular_subtypes that have more than 3 participants
metadata <- metadata %>%
