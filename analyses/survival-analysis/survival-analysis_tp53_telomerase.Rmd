...
meta_indep <- histologies_rna %>%
  ...
  # Recode a sample from Gross/Near total resection;Partial resection --> Partial resection
  mutate(extent_of_tumor_resection = ifelse(extent_of_tumor_resection == "Gross/Near total resection;Partial resection", 
                                            "Partial resection", 
                                            extent_of_tumor_resection))
```
