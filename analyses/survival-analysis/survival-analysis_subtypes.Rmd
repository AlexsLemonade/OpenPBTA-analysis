...
kap_meier_data_file <- file.path(results_dir, "logrank_hgg_subtypes_data.tsv") # data needed to make the KM plot
...
readr::write_rds(kap_fit$model, kap_meier_model_file)
# Save the data that went into the model for use in manuscript figure scripts
readr::write_tsv(metadata_ind_dna, kap_meier_data_file)
```
