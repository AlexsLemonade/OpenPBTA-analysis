...
> HGG samples do show some cell types with significance and quantifiable CIs: highher B cell fraction is benefit (p = 1.000222e-12), higher myeloid dendritic cell is benefit (p = 2.050876e-04), higher NK cell fraction is a risk (p = 5.008340e-18).
