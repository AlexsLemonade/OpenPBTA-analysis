...
2. Multivariate analysis for each cancer group, using immune cell types (minus uncharacterized) and PDL1 expression as covariates
3. Multivariate analysis for each cancer group, using immune cell types (minus uncharacterized), PDL1 expression, and molecular subtype as covariates
