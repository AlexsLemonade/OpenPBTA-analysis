...
> There is no signficant effect of PDL-1 expression. Although this P-value could be viewed as "approaching signficance," the large analysis sample size (N=689), this P-value is actually rather large.
...
Several effects are significant: 

+ extent of tumor resection gross/near total and partial are signficantly different from biopsy only.
+ LGG and non-LGG
...
> Most models here are not robust. **Only HGG** returns no warning messages. 
