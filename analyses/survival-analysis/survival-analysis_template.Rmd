...
```
Rscript -e "rmarkdown::render('analyses/survival-analysis/survival-analysis_template.Rmd', 
                              clean = TRUE)" 
```
...
tmb_file <- file.path(data_dir, "pbta-snv-consensus-mutation-tmb-all.tsv")
