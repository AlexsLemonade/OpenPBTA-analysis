...
-  `test`  : a character string noting which test to use. 
             **Supported tests:** 
             - `"kap.meier"` : For basic survival analysis. 
             - `"log.rank"` : For use with categorical variables.
             - `"cox.reg"` : For use with continuous variables.
