...
## make the bedtools intersect more general use
## set base intersect bedtools cmd to get PBTA intersection
BEDTOOLS_CMD="""bedtools intersect -a $DATA/WGS.hg38.strelka2.unpadded.bed -b $DATA/WGS.hg38.mutect2.vardict.unpadded.bed \
| bedtools intersect -a - -b $DATA/WGS.hg38.lancet.unpadded.bed"""
