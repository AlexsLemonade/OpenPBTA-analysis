...
expression_data <- read_rds(file.path(data_dir, "pbta-gene-expression-rsem-fpkm-collapsed.stranded.rds"))
```
...
Distinguishing the chrodoma samples with no copy number change chromosome 22
```{r}
