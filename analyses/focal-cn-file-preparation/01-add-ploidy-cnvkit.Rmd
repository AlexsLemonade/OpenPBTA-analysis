...
add_ploidy_df <- histologies_df %>%
  dplyr::select(Kids_First_Biospecimen_ID, tumor_ploidy, germline_sex_estimate) %>%
  dplyr::inner_join(cnvkit_df, by = c("Kids_First_Biospecimen_ID" = "ID")) %>%
  dplyr::select(-tumor_ploidy, -germline_sex_estimate, everything())
```
