...
```{r}
bed_output_file <-
  file.path("..", "..", "scratch", "consensus_seg_with_status.bed")
loss_bed_output_file <-
  file.path("..", "..", "scratch", "consensus_seg_with_status_losses.bed")
gain_bed_output_file <-
  file.path("..", "..", "scratch", "consensus_seg_with_status_gains.bed")
