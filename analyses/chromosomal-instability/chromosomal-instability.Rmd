...
sv_ranges <- GenomicRanges::GRanges(
    ...
    ranges = IRanges::IRanges(
      start = as.numeric(sv_breaks$pos),
      end = as.numeric(sv_breaks$pos)
    ),
    mcols = sv_breaks
  )
```
