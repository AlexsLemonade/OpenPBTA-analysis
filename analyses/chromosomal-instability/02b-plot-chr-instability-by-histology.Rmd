...
intersection_plot <- read_n_join(density_file = intersection_densities_file, 
  ...
  cdf_plot(plot_title = "Intersection of Breaks",
           num_col = "breaks_count",
           group_col = "short_histology",
           color = "#630882",
           n_group = params$min_samples,
           x_lim = c(-1.2, 1.2),
           y_lim = c(0, 30),
           x_lab = "",
           y_lab = "Chromosomal Breaks per Genome", 
           breaks = c(0, 3, 10, 30))

# Save plot
ggplot2::ggsave(intersection_cdf_plot_file)
```
...
# Save plot
ggplot2::ggsave(cnv_cdf_plot_file)
```
...
# Save plot
ggplot2::ggsave(sv_cdf_plot_file)
```
