...
output:   
  html_notebook: 
    toc: true
    toc_float: true
author: Candace Savonen for ALSF - CCDL, Jo Lynne Rokita for D3b
date: 2020
params:
  base_run:
...
```
Rscript -e "rmarkdown::render('analyses/chromosomal-instability/01-localization-of-breakpoints.Rmd', clean = TRUE)"
```
...
if ( params$base_run == 0 ){
  ...
  metadata_file <-file.path(data_dir,"pbta-histologies-base.tsv")
}
