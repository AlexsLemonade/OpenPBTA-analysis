...
If the sample is subtyped as part of molecular_subtyping_LGAT the sample will be present in compiled_subtypes_df. We will add integrated_diagnosis using the 
```{r}
