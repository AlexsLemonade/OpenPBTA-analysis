...
max_accuracy_index <- max(which(df_list[[target_column_list[[1]][which(target_column_list[[1]] ==
                      params$train_target_column)]]]$predictive_accuracy==
                      max(df_list[[target_column_list[[1]][which(target_column_list[[1]] ==
                      params$train_target_column)]]]$predictive_accuracy)))
