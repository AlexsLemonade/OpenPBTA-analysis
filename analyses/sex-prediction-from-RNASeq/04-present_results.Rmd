...
# here, we collect the predictive accuracy values from each confusion matrix file in the results directory  
  ...
  first_pos <- sapply(files_to_process, function(x) regexpr(params$seed, x))
...
The test set points are split on the x-axis by reported_gender (ground truth) values. Erroneous calls are displayed in red.  
