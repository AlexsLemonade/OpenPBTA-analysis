...
figS7d <- file.path(results_dir_threshold, "figure-S7d-data.csv")
figS7e <- file.path(results_dir_threshold, "figure-S7e-data.csv")
figS7f <- file.path(results_dir_threshold, "figure-S7f-data.csv")
