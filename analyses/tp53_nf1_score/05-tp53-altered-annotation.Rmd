...
ggviolin(tp53_alterations_score_wide, x = "tp53_altered", y = "tp53_score", 
  ...
  stat_compare_means(comparisons = mycomps, step.increase = 0.2, label.y = c(1.5, 1.3)) +
  # Add global p-value
...
ggsave(paste0(file.path, "tp53_scores_by_altered_status.png"))
...
ggsave(paste0(plot_dir, "/tp53_expression_by_altered_status_stranded.png"))
...
ggsave(paste0(plot_dir, "/tp53_expression_by_altered_status_polya.png"))
...
ggviolin(lfs, x = "tp53_altered", y = "tp53_score", 
  ...
  ylab("TP53 score") +
  rremove("legend")
ggsave(paste0(plot_dir, "/lfs_tp53_scores.png"))
