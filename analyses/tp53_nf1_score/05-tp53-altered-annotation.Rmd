...
mycomps <- list(c("activated", "Other"), c("loss", "Other"))

# Create table of statistics
# Default global test is kruskal-wallis
...
ggviolin(tp53_alterations_score_wide, x = "tp53_altered", y = "tp53_score", 
  ...
  # Add pairwise comparisons p-values - this is the non-adjusted p-value
  # stat_compare_means(comparisons = mycomps, step.increase = 0.2, label.y = c(1.5, 1.3), label = "p.format") +
