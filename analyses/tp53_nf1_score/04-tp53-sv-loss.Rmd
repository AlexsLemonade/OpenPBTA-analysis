...
manta_sv <- read_tsv(file.path(data_dir, "sv-manta.tsv.gz"), guess_max = 5000000)
rna_expr <- readRDS(file.path(data_dir, "gene-expression-rsem-tpm-collapsed.rds"))
...
```
BS_3NX3RBCX, BS_G6ASNYWP, BS_CQ40NN4X, BS_ZYXTC212, BS_B6E0477K, BS_MYVQ8YDT and BS_4D9SK48F have a CNV loss and multiple SV breakpoints overlapping TP53 locus!

BS_EJV0N3BX that previously had an overlap no longer exist - need to figure out why.
