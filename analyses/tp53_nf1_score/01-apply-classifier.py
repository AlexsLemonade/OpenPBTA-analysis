...
parser.add_option('-f', '--file',
                        dest='filename',
                        help='rds file genes expression X sample')
...
# Load RAS Classifier
file = os.path.join('analyses','tp53_nf1_score','reference', 'ras_classifier_coefficients.tsv')
...
file = os.path.join('analyses','tp53_nf1_score','reference', 'tp53_classifier_coefficients.tsv')
...
# Load NF1 Classifier
file = os.path.join('analyses','tp53_nf1_score','reference', 'nf1_classifier_coefficients.tsv')
