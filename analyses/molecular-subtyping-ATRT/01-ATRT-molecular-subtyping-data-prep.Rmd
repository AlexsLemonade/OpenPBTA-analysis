...
# Replace `NA` with `neutral` for focal status and `chr22q` variables
final_df$SMARCB1_focal_status <- final_df$SMARCB1_focal_status %>%
  tidyr::replace_na("neutral")

final_df$SMARCA4_focal_status <- final_df$SMARCA4_focal_status %>%
  tidyr::replace_na("neutral")

final_df$chr_22q_loss <- final_df$SMARCB1_focal_status %>%
  tidyr::replace_na("neutral")
