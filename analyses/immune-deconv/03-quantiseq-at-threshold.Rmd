...
Now we will re-plot the immune fractions across cancer groups for this filtered data.
...
The plot above recapitulates the result that monocytes are dominant in schwannomas and neurofibromas.
...
The plot shows that CD8+ T-cell infiltration across all cancer groups remains quite low.
The thresholded results are consistent.
...
The plot above shows that for DMG, overall fractions fall in ranges that are consistent with other cancer groups, so "higher overall fractions" are no longer the case. 
...
To assess this result, we will re-make this supplementary figure - 
...
The plot itself has fewer subtypes, which is expected with a filtered dataset.
...
Overall, `quanTIseq` results are highly consistent after thresholding.
