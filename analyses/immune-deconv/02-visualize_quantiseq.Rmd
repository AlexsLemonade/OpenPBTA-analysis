...
ggsave(cg_celltypes_plot_file, cg_plot, width = 11, height = 3.5, useDingbats=FALSE, useDingbats=FALSE)
```
...
ggsave(subtypes_celltypes_plot_file, subtypes_celltypes_plot, width = 13, height = 4, useDingbats=FALSE)
```
