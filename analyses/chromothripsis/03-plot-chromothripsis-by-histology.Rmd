...
p <- ggplot(chromoth_histology_summary, aes(x = display_group, y = prop, fill = hex_codes)) +
  ...
  plot_options
p
ggsave(file.path(plots_dir, "chromothripsis_proportion_by_displayGroup.pdf"), p, width=7, height=7)
```
...
p <- ggplot(chromoth_histology_summary_cg, aes(x = cancer_group, y = prop, fill = cancer_group_hex_codes)) +
  ...
  ylab("Proportion of Tumors")
p
ggsave(file.path(plots_dir, "chromothripsis_proportion_by_cancerGroup.pdf"), p, width=7, height=7)
```
...
p <- ggplot(chromoth_histology_summary_cg_by_dg, aes(x = display_group, y = prop_cancer_group, 
  ...
  plot_options
p
ggsave(file.path(plots_dir, "chromothripsis_proportion_by_displayGroup_fillByCancerGroup.pdf"), p, width=7, height=7)
```
...
p <- ggplot(chromoth_histology, aes(x = display_group, 
  ...
  plot_options
p
ggsave(file.path(plots_dir, "chromothripsis_proportion_by_displayGroup_fillByConfidence.pdf"), p, width=7, height=7)
```
...
p <- ggplot(chromoth_histology, aes(x = display_group, fill = as.factor(count_regions_any_conf))) +
  ...
  plot_options
p
ggsave(file.path(plots_dir, "chromothripsis_proportion_by_displayGroup_fillByCount.pdf"), p, width=7, height=7)
```
