...
# Zenodo table directory and file name
zenodo_tables_dir <- file.path(root_dir, "tables", "zenodo-upload")
fig3c_csv <- file.path(zenodo_tables_dir, "figure-3c-data.csv")
...
p <- merge %>%
  ...
  geom_point(shape=21, size=2, color="black", stroke = 0.25) + 
...
ggsave(file.path(plots_dir, "count_chromothripsis_cnv_and_sv_breaks_scatterplot.pdf"), p, 
       useDingbats=FALSE, height = 5.25, width = 7.75)
```
