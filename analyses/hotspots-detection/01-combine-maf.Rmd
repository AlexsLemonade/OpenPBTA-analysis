---
title: "Filter individual caller for hotspot and combine"
...
- "mutect" which has all mutect2 calls with [maf fields](https://github.com/AlexsLemonade/OpenPBTA-analysis/blob/2c1f5faf1f5687fa40b9b30fa6442798bd38557d/analyses/snv-callers/scripts/01-setup_db.py#L83-L219) 
- "vardict" which has all vardict calls in maf format [maf fields](https://github.com/AlexsLemonade/OpenPBTA-analysis/blob/2c1f5faf1f5687fa40b9b30fa6442798bd38557d/analyses/snv-callers/scripts/01-setup_db.py#L83-L219)
...
print("Subsetting strelka2 calls for hotspots")
...
print("Subsetting mutect2 calls for hotspots")
...
print("Subsetting vardict calls for hotspots")
...
print("Subsetting lancet calls for hotspots")
