...
The main tasks are:
 - filter `combined_maf_hotspots_filt` to calls that are not found in consensus calls
...
saveRDS(combined_maf_hotspots_filt,file.path(root_dir,"scratch","combined_hotspots.RDS"))
