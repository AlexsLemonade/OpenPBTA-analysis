...
lancet and vardict have majority of the unique calls. However, some calls from lancet,mutect2 and vardict seem to be below the red line which denotes t_alt_count==5.
