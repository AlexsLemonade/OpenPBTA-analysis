...
# PRAG1 errored out because maftools didn't have it's gene structure
lapply(c("TYRO3","PIM3","ACVRL1","GAK","GRK2","PKN1","CDKL4","ULK1","RPS6KA4"),function(x){
maftools::lollipopPlot(kinasedomains_novel_sites,gene = x ,AACol = "HGVSp_Short")})
dev.off()
```
