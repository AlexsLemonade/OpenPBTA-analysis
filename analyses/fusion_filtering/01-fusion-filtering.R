...
# star fusion
sf<-read.delim(gzfile(paste0("../../data/",Sys.readlink2("../../data/pbta-fusion-starfusion.tsv.gz"))),stringsAsFactors=F,,header=T,sep="\t")
#head(sf)
...
# arriba fusion
ar <- read.delim(gzfile(paste0("../../data/",Sys.readlink2("../../data/pbta-fusion-arriba.tsv.gz"))),stringsAsFactors=F,,header=T,sep="\t")
...
#histology
clin<-read.delim(paste0("../../data/",Sys.readlink2("../../data/pbta-histologies.tsv")),stringsAsFactors = F,sep="\t")
