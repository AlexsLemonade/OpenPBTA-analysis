...
```{r}
inputfolder<-file.path("~/Documents/OpenPBTA-analysis/")
setwd(inputfolder)
...
write.table(QCGeneFiltered_filtFusion,"analyses/fusion_filtering/results/FilteredFusion.tsv",sep="\t",quote=FALSE,row.names = FALSE)
