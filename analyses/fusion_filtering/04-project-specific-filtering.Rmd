...
fusion_calls<-full_join(fusion_caller.summary,fusion_read.summary,by=(c("Sample","FusionName")))
...
fusion_calls$Distance<-unlist(lapply(fusion_calls$annots,function(x) ex_between(x, "LOCAL_REARRANGEMENT:-:[", "]")[[1]]))
