...
Here I plot some barplots to identify fusions found in more than 4 broad_histologies to tackle the issue above. (We have decided morethan 4 here because we have seen that some known fusions like EWSR1−−FLI1 is seen is 4 different broad_histologies in our current clinical file)
