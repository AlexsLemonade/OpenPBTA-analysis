...
This database was originally created by the [run consensus bash script](https://github.com/AlexsLemonade/OpenPBTA-analysis/blob/master/analyses/snv-callers/run_caller_consensus_analysis-pbta.sh)

```{r}
set_up_pbta <- function(data.name) {
  # Given the name of dataset in the PBTA database, set up the TCGA data. 
...
This database was originally created by the [run consensus bash script for tcga](https://github.com/AlexsLemonade/OpenPBTA-analysis/blob/master/analyses/snv-callers/run_caller_consensus_analysis-tcga.sh)

```{r}
set_up_tcga <- function(data.name) {
  # Given the name of dataset in the TCGA database, set up the TCGA data. 
