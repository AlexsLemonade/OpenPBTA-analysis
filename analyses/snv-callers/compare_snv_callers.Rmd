...
caller_dirs <- grep("vaf_cutoff|consensus", dir(base_results_dir, full.names = TRUE), invert = TRUE, value = TRUE)
...
vaf_files <- sapply(caller_dirs, 
                    list.files, pattern = "_vaf", recursive = TRUE, full.names = TRUE)
...
tmb_files <- sapply(caller_dirs, 
                    list.files, pattern = "_tmb", recursive = TRUE, full.names = TRUE)
