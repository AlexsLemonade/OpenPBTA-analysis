...
vaf_df <- readr::read_rds(file.path(results_dir, "all_callers_vaf.rds"))

# Master TMB data.frame
tmb_df <- readr::read_rds(file.path(results_dir, "all_callers_tmb.rds"))

# Full mutation list
mutation_id_list <- readr::rds(file.path(results_dir, "mutation_id_list.rds"))

# Callers per mutation data.frame
callers_per_mutation <- readr::rds(file.path(results_dir, "callers_per_mutation.rds"))
```
