...
```{r}
compare_results_dir <- file.path(base_results_dir, "consensus")
compare_plots_dir <- file.path(base_plots_dir, "consensus")
...
consen_mutation <- vaf_df %>%
  ...
  readr::write_tsv(file.path(consensus_results_dir, "conensensus_mutation.maf.tsv"))
```
...
```{r}
zip(
  file.path(consensus_results_dir, "conensensus_mutation.maf.tsv.zip"),
  file.path(consensus_results_dir, "conensensus_mutation.maf.tsv")
)
```
