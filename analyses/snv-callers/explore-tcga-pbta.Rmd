...
Function for comparing TMB for TCGA and PBTA and printing out a sina plot. 
...
tmb_combo <- function(pbta_df, tcga_df, data.name) {
  ...
  pbta_plot <- sina_plot(pbta_coding_df, colour = "#630882", title = "PBTA") +
      ggplot2::theme(
      panel.grid.major.x = ggplot2::element_line(colour = c("gray93", "white"), size = 12)
    )
...
Download the Target BED regions file from MC3, and format the chromosome data to 
