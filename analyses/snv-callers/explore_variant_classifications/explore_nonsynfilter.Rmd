---
title: "Explore Non Synonymous Filters"
output: 
  html_notebook:
    toc: TRUE
    toc_float: TRUE
...
```
Rscript -e "rmarkdown::render('analyses/snv-callers/explore_noonsynfilter.Rmd', 
                              clean = TRUE)"
```
...
```{r}
plots_dir <- file.path("..", "plots", "explore_var_class")
...
Ran this on AWS to get the TMB files. 
```
