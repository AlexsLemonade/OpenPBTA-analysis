...
all_lgat_matched <- full_join(lgat_dna, lgat_rna,
                         by = c("Kids_First_Participant_ID",
                                ...
                                "pathology_free_text_diagnosis"),
                         suffix = c("_DNA", "_RNA")) %>%
  dplyr::select(starts_with("Kids_First"), sample_id,pathology_free_text_diagnosis)
...
all_subtype <- bind_rows(all_rna_subtype,
  ...
  dplyr::mutate(molecular_subtype = case_when(
    ...
    ((molecular_subtype=="NA"|is.na(molecular_subtype)) & 
       !is.na(Kids_First_Biospecimen_ID_DNA) &
  ...
  dplyr::mutate(molecular_subtype = if_else(str_detect(pathology_free_text_diagnosis,
                                                       paste(path_dx_list$recode_path_free_text,collapse = "|")),
                                            gsub("LGG,","GNT,",molecular_subtype),molecular_subtype)) %>%
