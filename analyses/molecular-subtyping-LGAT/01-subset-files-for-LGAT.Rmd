...
What are the distribution of Variant_Classification of the SNVs captured per gene.
...
We will remove synonymous variant calls from the list above. The Variant_Classification terms for synonymous SNV are selected as per interaction-plots/scripts/02-process_mutations.R
```{r}
...
Lets check if all LGAT DNA biospecimens have a subtype defining SNV
