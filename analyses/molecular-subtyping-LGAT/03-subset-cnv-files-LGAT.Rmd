...
overlaps_manta <- IRanges::subsetByOverlaps(manta_gr, domain_gr)
...
cnv_fgfr_gr <- IRanges::subsetByOverlaps(cnv_gr, fgfr_gene,type="within",maxgap = )

# overlap consensus seg with exon
overlaps_fgfr_cnv <- IRanges::subsetByOverlaps(cnv_fgfr_gr,domain_gr) 

# filter for fgfr only overlap
overlaps_fgfr_cnv <- overlaps_fgfr_cnv[which(
...
# get exons and exon_id for FGFR1 canonical transcript
fgfr1_exons<-GenomicFeatures::exons(txdb, 
...
overlaps_cnv_fgfr_exon <- IRanges::mergeByOverlaps(overlaps_fgfr_cnv,fgfr1_exons) 
