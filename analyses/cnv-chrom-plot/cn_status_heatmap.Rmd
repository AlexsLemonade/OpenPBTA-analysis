...
# Read in the calculation file if it was already made
if (file.exists(file.path(results_dir, "cn_status_bp_per_bin.tsv"))) {
  # Read in file
...
histologies <-
  ...
  dplyr::inner_join(metadata %>%
    dplyr::select(Kids_First_Biospecimen_ID, short_histology, sample_color, group_n)) %>%
...
heatmap <- ComplexHeatmap::Heatmap(
  ...
  cluster_rows = FALSE,
  rect_gp = grid::gpar(col = "black", lwd = .01),
