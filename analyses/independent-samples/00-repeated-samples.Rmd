...
seq_samples <- sample_df %>%
  filter(experimental_strategy %in% c("WGS", "WXS", "Targeted Sequencing", "Targeted-Capture"), 
         sample_type == "Tumor")
```
...
So there are currently 16 samples with missing WGS data, but that may change in a future release.
