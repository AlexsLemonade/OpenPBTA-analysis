...
`tumor_types = "any"` if we want to be less presecriptive. 

In the accompanying script, I generate both `primary_only` and `primary_plus` 
...
```{r}
sample_df %>% 
  filter(Kids_First_Biospecimen_ID %in% independents) %>%
