...
The purpose is to identify samples that may need to be reclassified as LGAT instead of HGAT using clustering.
...
polya_expression <- readr::read_rds(file.path(data_dir, "pbta-gene-expression-rsem-fpkm-collapsed.polya.rds"))
