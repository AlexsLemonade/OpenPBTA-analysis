...
In this notebook we will annotate HGG samples with TP53 status we obtained from snv/cnv and tp53 loss classifier. We belive TP53 annotation will add useful information to the current known subtypes as we see Tp53 mutated co-occuring with H3 mutations
...
hgg_subtypes <- hgg_subtypes %>%
  ...
  mutate(molecular_subtype= case_when(
    tp53_altered=="activating" ~ stringr::str_c(molecular_subtype,", TP53 activated"),
