...
We will use the 2016 WHO Classification as our guide ([Louis et al. _Acta Neuropathol._ doi: 10.1007/s00401-016-1545-1](10.1007/s00401-016-1545-1)) and take a look at the current version of the histology file (`release-v18-20201123`).
...
## Pathology free text diagnosis inclusion criteria
Gliomatosis Cerebri can be high grade glioma or low grade glioma so we will add an inclusion criteria for v18 release to only keep `Gliomatosis Cerebri` samples if pathology_free_text_diagnosis as `anaplastic gliomatosis cerebri (who grade 4)`
```{r}
