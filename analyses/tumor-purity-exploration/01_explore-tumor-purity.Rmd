...
plot_tumor_violins <- function(df, display_name, display_hex) {
  ggplot(df) + 
...
# Cancer group
plot_tumor_violins(tumor_palette_df, cancer_group_display, cancer_group_hex)

# Broad histology
plot_tumor_violins(tumor_palette_df, broad_histology_display, broad_histology_hex)
```
