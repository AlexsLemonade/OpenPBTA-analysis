...
######## Define output files
file_anova_stranded_cancer_group  <- file.path(results_dir, "gsva_anova_stranded_cancer_group.RDS")
file_anova_polya_cancer_group     <- file.path(results_dir, "gsva_anova_polya_cancer_group.RDS")
file_anova_stranded_harmonized_diagnosis <- file.path(results_dir, "gsva_anova_stranded_harmonized_diagnosis.RDS")
file_anova_polya_harmonized_diagnosis    <- file.path(results_dir, "gsva_anova_polya_harmonized_diagnosis.RDS")


file_tukey_stranded_cancer_group  <- file.path(results_dir, "gsva_tukey_stranded_cancer_group.RDS")
file_tukey_polya_cancer_group     <- file.path(results_dir, "gsva_tukey_polya_cancer_group.RDS")
file_tukey_stranded_harmonized_diagnosis <- file.path(results_dir, "gsva_tukey_stranded_harmonized_diagnosis.RDS")
file_tukey_polya_harmonized_diagnosis    <- file.path(results_dir, "gsva_tukey_polya_harmonized_diagnosis.RDS")
...
write_rds(cancer_group_stranded_model_results[["anova"]],  file_anova_stranded_cancer_group)
write_rds(harmonized_diagnosis_stranded_model_results[["anova"]], file_anova_stranded_harmonized_diagnosis)
write_rds(cancer_group_stranded_model_results[["tukey"]],  file_tukey_stranded_cancer_group)
write_rds(harmonized_diagnosis_stranded_model_results[["tukey"]], file_tukey_stranded_harmonized_diagnosis)
...
if (!(running_in_ci)){
  ...
  write_rds(cancer_group_polya_model_results[["anova"]],     file_anova_polya_cancer_group)
  write_rds(harmonized_diagnosis_polya_model_results[["anova"]],    file_anova_polya_harmonized_diagnosis)
  write_rds(cancer_group_polya_model_results[["tukey"]],     file_tukey_polya_cancer_group)
  write_rds(harmonized_diagnosis_polya_model_results[["tukey"]],    file_tukey_polya_harmonized_diagnosis)
