...
# Download the file
download.file("https://open-pbta.s3.amazonaws.com/data/snv-consensus/snv-consensus_11122019.zip", 
              destfile = file.path(data_dir, "snv-consensus_11122019.zip"))

# Get the files in this zip file
unzip(file.path(data_dir, "snv-consensus_11122019.zip"),
      exdir = data_dir)
}
```
