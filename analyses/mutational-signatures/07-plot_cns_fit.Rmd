...
ggplot2::ggsave(exposures_sample_barplot_file, sample_exposures_barplot, width = 8, height = 7)
...
if (!(params$is_ci == 1)) {
  ...
  # Save the plots
  ggplot2::ggsave(signature1_tumor_cancergroups_file, sig1_tumor_cancergroups, width = 8, height = 5)
  ggplot2::ggsave(signature1_tumor_molecularsubtypes_file, sig1_tumor_molsubs, width = 14, height = 6)
}
