...
barplot_data <- df_signature_mutations_per_mb %>%
  ...
  dplyr::summarize(
      ...
      q1_mutation_per_mb_exposed  = quantile(median_mutations_per_mb_exposed , 0.25),
      q3_mutation_per_mb_exposed  = quantile(median_mutations_per_mb_exposed , 0.75)
    ) %>%
  dplyr::ungroup() %>%
