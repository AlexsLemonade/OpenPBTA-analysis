...
Here we are using v18 `pbta-histologies-base.tsv` which has integrated_diagnosis,Notes and molecular_subtype as NA. Through all the following molecular subtyping modules:
...
we gathered and updated molecular-subtype/integrated_diagnosis/broad_histology/short_histology. 
...
For samples that where pathology_diagnosis is "Other" we also update the file broad_histology and short_histology from a manual review of WHO terms.
