...
histology<- histology %>%
  ...
  dplyr::mutate(cancer_group = case_when(cancer_group == "Brainstem glioma- Diffuse intrinsic pontine glioma" ~ "Diffuse intrinsic pontine glioma",
                                         ...
                                         # TODO update after typo is fixed for the term below	
                                         cancer_group == "Adamantimomatous craniopharyngioma" ~ "Craniopharyngioma",
