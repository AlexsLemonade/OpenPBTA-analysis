...
Just a note, integrated_diagnosis == NA is expected for samples where subtyping is not performed or is molecular_subtype == "XYZ,To be classified" because no evidence was provided/available for these samples we are not able to add integrated_diagnosis.
