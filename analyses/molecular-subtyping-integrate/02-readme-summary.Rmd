...
histology_select %>% 
  ...
  readr::write_tsv("results/cancer_group_post_subtype_removal_match.tsv")
...
histology_select %>% 
  ...
  distinct() %>%
  dplyr::arrange(cancer_group) %>% 
  readr::write_tsv("results/cancer_group_harmonized_diag_match.tsv")
```
