...
# run MB molecular subtyping (with batch correction)
...
--outputfile results/mb-molecular-subtypes-batch-correct-medullo-classifier.rds

# merge expected and observed outputs
Rscript 02-compare-classes.R \
--observed_class results/mb-molecular-subtypes-batch-correct-medullo-classifier.rds \
--expected_class input/expected_class.rds \
--outputfile results/comparison-batch-correct-medullo-classifier.rds
