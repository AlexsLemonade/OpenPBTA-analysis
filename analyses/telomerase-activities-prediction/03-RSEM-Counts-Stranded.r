...
PTBA_GE_Standard = readRDS('../../data/pbta-gene-counts-rsem-expected_count.stranded.rds')
...
file.rename((pattern="TelomeraseScores.txt"), paste0("TelomeraseScores_Stranded_RsemCounts.txt"))
