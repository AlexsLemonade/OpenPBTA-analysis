...
# Bind rows of dataframes in cnv_filtered
combined_cnv_filtered <- dplyr::bind_rows(cnv_filtered, .id = "cnv_caller") 
...
# Save plot
pdf(file.path("plots", "compare_cnv_output_violin_plot.pdf"), height = 12, width = 30)
cnv_violin_plots
dev.off()
...
cnv_histology_barplots <- plot_histology_barplot(combined_cnv_filtered, metadata)

# Save plot
pdf(file.path("plots", "compare_cnv_output_barplot_histology.pdf"), height = 12, width = 30)
...
# Save plot
pdf(file.path("plots", "compare_cnv_output_barplot_aberration.pdf"), height = 12, width = 30)
