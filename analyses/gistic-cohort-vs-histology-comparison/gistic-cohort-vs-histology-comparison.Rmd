...
cohort_sample_seg_counts <- file.path(cohort_gistic_dir, "sample_seg_counts.txt")
lgat_sample_seg_counts <- file.path(lgat_gistic_dir, "sample_seg_counts.txt")
plot_sample_seg_counts(cohort_sample_seg_counts, lgat_sample_seg_counts)

# Run comparison using HGAT file
hgat_sample_seg_counts <- file.path(hgat_gistic_dir, "sample_seg_counts.txt")
plot_sample_seg_counts(cohort_sample_seg_counts, hgat_sample_seg_counts)

# Run comparison using medulloblastoma file
medulloblastoma_sample_seg_counts <- file.path(medulloblastoma_gistic_dir, "sample_seg_counts.txt")
