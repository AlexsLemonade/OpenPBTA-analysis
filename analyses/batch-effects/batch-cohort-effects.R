...
# function used for building file paths
...
run_batchQC(dat_rsem_stranded, id_batch, gene_id = dat_rsem_stranded$gene_id, report_name = "rsem_stranded_cohort_report.html", "pbta-gene-expression-rsem-tpm-combat-cohort.stranded.rds", FALSE)
...
run_batchQC(dat_kallisto_stranded, id_batch, gene_id = dat_kallisto_stranded$gene_id, report_name = "kallisto_stranded_cohort_report.html", "pbta-gene-expression-kallisto-combat-cohort.stranded.rds", FALSE)
