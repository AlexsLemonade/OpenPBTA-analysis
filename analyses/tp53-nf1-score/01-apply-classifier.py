...
# Load RAS Classifier
file = os.path.join(
    "analyses", "tp53-nf1-score", "reference", "ras_classifier_coefficients.tsv"
)
...
file = os.path.join(
    "analyses", "tp53-nf1-score", "reference", "tp53_classifier_coefficients.tsv"
)
...
# Load NF1 Classifier
file = os.path.join(
    "analyses", "tp53-nf1-score", "reference", "nf1_classifier_coefficients.tsv"
)
...
print(filename)
file = os.path.join("analyses", "tp53-nf1-score", "results", filename)
