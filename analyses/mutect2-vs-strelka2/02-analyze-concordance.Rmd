...
```{r}
barplot_var <- function(df, variable_name = NULL, filter_cutoff = .02, 
...
```{r}
barplot_var(df = "vaf_df", variable_name = "change", filter_cutoff = .01, 
                        as_percent = TRUE)
```

```{r}
barplot_var(df = "vaf_df", variable_name = "coding", filter_cutoff = .01, 
                        as_percent = TRUE)
```
