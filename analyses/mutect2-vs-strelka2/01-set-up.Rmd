...
- `analyses/mutect2-vs-strelka2/plots/gene_summary_cor_strelka-vs-mutect2.pdf`  
- `analyses/mutect2-vs-strelka2/plots/sample_summary_cor_strelka-vs-mutect2.pdf`  
...
```{r}
maftools::plotTiTv(maftools::titv(strelka2), plotType = 'box')
```

#### MuTect2 transition/transversion plot.

```{r}
maftools::plotTiTv(maftools::titv(mutect2), plotType = 'box')
```
...
# Save to a PDF
ggplot2::ggsave(file.path("plots", "gene_summary_cor_strelka-vs-mutect2.pdf"))
```
...
# Save to a PDF
ggplot2::ggsave(file.path("plots", "sample_summary_cor_strelka-vs-mutect2.pdf"))
```
...
strelka2_vaf %>%
  dplyr::select(vaf, base_change, coding, change, mutation_id)
```
