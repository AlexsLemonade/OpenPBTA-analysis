...
This notebook is sets up the MAF data files for comparison and does some first 
line analyses
...
if (all(files_needed)) {
  ...
  strelka2_samples <- data.table::fread(file.path(data_dir, "pbta-snv-strelka2.vep.maf.gz"),
                                      select = "Tumor_Sample_Barcode", 
                                      skip = 1, 
                                      data.table = FALSE)

  mutect2_samples <- data.table::fread(file.path(data_dir, "pbta-snv-mutect2.vep.maf.gz"),
                                      select = "Tumor_Sample_Barcode", 
                                      skip = 1, 
                                      data.table = FALSE)
