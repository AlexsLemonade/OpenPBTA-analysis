...
getRecurrentStatus<- function(table,
  ...
  columns <-c("Chromosome","Start_Position","End_Position","Hugo_Symbol","Variant_Classification","Tumor_Sample_Barcode" ,"Protein_position","DOMAINS")
  ...
  calls_base_recurrence <- calls_base %>%
    ...
    count(Protein_position,Hugo_Symbol,DOMAINS,type,sort = TRUE)
