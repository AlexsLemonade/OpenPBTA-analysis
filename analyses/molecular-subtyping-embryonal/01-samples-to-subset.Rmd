...
pnet_df <- embryonal_df %>%
  # Inclusion on the basis of defined pathology diagnosis term in `path_dx_list$include_path_dx`
  filter(str_to_lower(pathology_diagnosis) %in% path_dx_list$include_path_dx)
```
...
pathology_free_text_df <- embryonal_df %>%
  # Inclusion on the basis of `pathology_diagnosis == "Other"` and defined pathology free text diagnosis terms in `path_dx_list$include_free_text`
