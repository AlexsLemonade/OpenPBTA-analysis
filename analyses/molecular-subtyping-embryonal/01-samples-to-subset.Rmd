...
Drop medulloblastoma and ATRT samples using the `pathology_diagnosis` labels.

```{r}
embryonal_df <- embryonal_df %>%
  filter(!(pathology_diagnosis %in% c("Medulloblastoma",
                                   "Atypical Teratoid Rhabdoid Tumor (ATRT)")))
```

Is there anything in the `integrated_diagnosis` column we should be concerned about removing?
