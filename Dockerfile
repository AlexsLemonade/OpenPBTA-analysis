...
RUN pip3 install "statsmodels==0.10.2" "plotnine==0.6.0" "scikit-learn==0.19.1" "rpy2==2.9.3" "seaborn==0.8.1" "jupyter==1.0.0" "ipykernel==4.8.1" "widgetsnbextension==2.0.0" "nb_conda_kernels==2.1.0"
