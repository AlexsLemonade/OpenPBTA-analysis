...
RUN R -e "install.packages('lifecycle', 'cpp11',dependencies = TRUE,repos = 'http://cran.us.r-project.org')
RUN R -e "install.packages('cpp11',dependencies = TRUE,repos = 'http://cran.us.r-project.org')
