...
table_key_resources_file <- file.path(results_dir, "Key-Resources-table.xlsx")
```
...
This is not a supplementary table according to [Author guidelines](https://www.cell.com/star-supplemental-information).


```{r table_key_resources}
...
# Combine and output
list_key_resources_table <- list(r_packages = r_packages,
                      python_libraries = python_libraries,
                      other_command_line_tools = cli_tools,
                      workflow_repository_tools = workflow_tools
                      )
write.xlsx(list_key_resources_table, 
           table_key_resources_file, 
           overwrite=TRUE, 
           keepNA=TRUE)
