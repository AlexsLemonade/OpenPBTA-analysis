...
soi_df <- tmb_hist %>%
  ...
  mutate(`Therapy post-biopsy` = case_when(
      ...
      Kids_First_Biospecimen_ID == "BS_F0GNWEJJ" ~ "Nivolumab, Radiation",
      sample_id == "7316-2189" ~ "Unknown",
    ),
    # add Lynch syndrome
    cancer_predispositions = case_when(
      Kids_First_Biospecimen_ID == "BS_8AY2GM4G" ~ "NF-1, Lynch syndrome",
      sample_id == "7316-3058" ~ "Lynch Syndrome",
    ...
    # add pathogenic germline variants
    `Pathogenic germline variant` = case_when(
      Kids_First_Participant_ID == "PT_3CHB9PK5" ~ "MSH6",
      Kids_First_Participant_ID == "PT_0SPKM4S8" ~ "PMS2",
      Kids_First_Participant_ID == "PT_VTM2STE3" ~ "None detected",
      Kids_First_Participant_ID == "PT_EB0D3BXG" ~ "None detected",
      Kids_First_Participant_ID == "PT_S0Q27J13" ~ "None detected",
      Kids_First_Participant_ID == "PT_JNEV57VK" ~ "MSH2"
      ),
