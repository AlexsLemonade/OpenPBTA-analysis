...
histology_df %>%
  ...
  distinct(pbta_broad_histology, molecular_subtype, sample_id) %>%
  # Count broad histology and subtype combinations
  count(pbta_broad_histology, molecular_subtype) %>%
  # export
...
workflow_tools <- tribble(
  ...
  "SNPeff", "4.3t", "https://sourceforge.net/projects/snpeff/files/snpEff_v4_3t_core.zip",
  "ANNOVAR", "2020Jun08", "https://annovar.openbioinformatics.org/",
  "InterVar", "2.2.2", "https://github.com/WGLab/InterVar/blob/4801682d37982bb3e99b50392790878a568b42cd/Intervar.py"
)
