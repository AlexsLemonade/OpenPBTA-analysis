...
soi_df <- tmb_hist %>%
  ...
  mutate(`Therapy post-biopsy` = case_when(
    ...
    cancer_predispositions = case_when(
      Kids_First_Biospecimen_ID == "BS_8AY2GM4G" ~ "Lynch syndrome",
      sample_id == "7316-515" ~ "Other inherited conditions NOS",
    ...
    `Pathogenic germline variant` = case_when(
      Kids_First_Participant_ID == "PT_3CHB9PK5" ~ "MSH6 NM_000179.2 c.3439-2A>G splice (P)",
      Kids_First_Participant_ID == "PT_0SPKM4S8" ~ "PMS2 p.S46I (LP)",
      ...
      Kids_First_Participant_ID == "PT_JNEV57VK" ~ "MSH2 p.A636P (P)"
      ),
...
workflow_tools <- tribble(
  ...
  "RSEM", "1.3.1", "https://github.com/d3b-center/OpenPBTA-workflows/blob/master/cwl/kfdrc_RNAseq_workflow.cwl",
  "RNA-SeQC", "2.4.2", "https://github.com/d3b-center/OpenPBTA-workflows/blob/master/cwl/kfdrc_RNAseq_workflow.cwl",
  ...
  "SNPeff", "4.3t", "https://github.com/d3b-center/OpenPBTA-workflows/blob/master/cwl/clinvar_pathogenic_filter.cwl",
