...
# Gather all BS_IDs (soi = "samples of interest"), whether hypermutant or not, for pts with hypermutant samples
  soi_df <- tmb_hist %>%
    ...
    # select relevant columns
      select(Kids_First_Participant_ID, Kids_First_Biospecimen_ID, sample_id, tumor_descriptor, `Therapy post-biopsy`, cancer_predispositions, tmb, composition, molecular_subtype) %>%
